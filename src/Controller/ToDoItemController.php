...
use App\ApplicationService\NaturalLanguageProcessingApplicationService;
...
use App\Form\NLPToDoAddFormType;
...
class ToDoItemController extends BaseController
{
    ...
    /**
     * @Route("/toDoItem/{slug}/newNLP", name="to_do_new_NLP")
     */
    public function addWithNLP( Request $request,
                         WorkspaceApplicationService $workspaceService,
                         ToDoItemApplicationService $toDoService,
                         TagApplicationService $tagService,
                         NaturalLanguageProcessingApplicationService $nlpService)
    {
        ...
        $form = $this->createForm(NLPToDoAddFormType::class,null, [
            'workspace'=>$workspace
        ]);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            //unproccesedToDoItem
            $unprocessedToDoItem=$form->getData();
            $toDoItem=$nlpService->processToDo($unprocessedToDoItem);
            ...
            $toDoService->addToDoItem($toDoItem);
            $this->addFlash('success', 'ToDo Item Created!');
            return $this->redirectToRoute('app_homepage');
        }
        return $this->render('nlp_operations/add.html.twig', [
            'toDoItemForm' => $form->createView(),
            'workspace'=>$workspace,
            'customWorkspaces'=>$customWorkspaces
        ]);
